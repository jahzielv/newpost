...
let argv = yargs
    ...
    .command(
        "post_name",
        "Creates a new post called 'today-in-iso8601.post_name.md', with the front matter specified in your front matter config. The front matter title property is set to post_name by default."
    )
    .command(
